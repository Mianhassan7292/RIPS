...
const Reseller = ({ data }) => {
  ...
  const getInventoryData = async () => {
    ...
    await axios
      .get(`${process.env.REACT_APP_BASE_URL}/get/reseller/product`, {
        headers: {
  ...
  const handelAddProductSubmit = async (e) => {
    ...
    await axios
      .post(
        `${process.env.REACT_APP_BASE_URL}/add/reseller/inventory`,
        {
          productName: name,
  ...
  return (
    <div style={{ margin: "10px", width:"100%" }}>
      <h2 style={{ fontSize: "25px" }}>Add Products For Reselling</h2>
      <div className="search-add-container1">
        <input
        ...
        />
        <button onClick={openModal} className="add-item-button1">
          Add&nbsp;Product
        </button>
      </div>
      <table>
        ...
        >
          <CModalBody>
            <div className="add-modal-main-div">
              ...
              <h3 style={{ textAlign: "center" }}>Add Product For Reselling</h3>
